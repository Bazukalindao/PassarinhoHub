...
W:AddLabel("[+] Passarinho Hub is HERE!")
...
M:AddParagraph("Kaitun/Cantay","BAZUKA HUB.")

M:AddToggle({
    Name = "Kaitun[Não há jogadores mortos]",
    Default = false,
    Flag = "Kaitun",
    Save = true,
    Callback = function(Value)
